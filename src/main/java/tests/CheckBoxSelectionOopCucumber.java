...
import static factories.SearchCriteriaFactory.getCriteria;
...
import factories.SearchCriteriaFactory;

public class CheckBoxSelectionOopCucumber {
...
//	Predicate<List<WebElement>> allFemale = (l) -> l.get(1).getText().equalsIgnoreCase("female");
	...
	public Object[] tableData() {
		...
		return new Object[] { SearchCriteriaFactory.getCriteria("allMale"), getCriteria("allFemale"),
				getCriteria("allGender"), getCriteria("allAU"), getCriteria("allFemaleAU") };
	}
